  ...
  static void init() {
    ...
    if (CPU::id() == Traits<CPU>::BSP) {
      ...
      Clock_Controller::reset(
          Clock_Controller::SYSCRG_CLK_RSTN_U1_GMAC5_AXI64_ARESETN_I);
      Clock_Controller::reset(
          Clock_Controller::SYSCRG_CLK_RSTN_U1_GMAC5_AXI64_HRESET_N);
      ...
      Clock_Controller::invert(
          Clock_Controller::AONCRG_CLK_GMAC5_AXI64_TX_INVERTER, true);
      ...
      Clock_Controller::reset(
          Clock_Controller::AONCRG_CLK_RSTN_GMAC5_AXI64_AXI);
      Clock_Controller::reset(
          Clock_Controller::AONCRG_CLK_RSTN_GMAC5_AXI64_AHB);
      /* ---***--- CAN0 ---***--- */
      ...
      Clock_Controller::reset(
          Clock_Controller::SYSCRG_CLK_RSTN_U0_CAN_CTRL_APB);
      Clock_Controller::reset(
