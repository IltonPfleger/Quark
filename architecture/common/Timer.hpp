...
class Timer {
  ...
  static constexpr uintmax_t AlarmFrequency =
      TimerFrequency / Traits<Alarm>::Frequency;
  static constexpr uintmax_t ThreadFrequency =
      TimerFrequency / Traits<Thread>::Frequency;
