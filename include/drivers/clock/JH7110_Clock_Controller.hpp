...
template <typename> class JH7110_Clock_Controller : Driver {
  ...
  public:
    enum {
        ...
        SYSCRG_CLK_TEMPERATURE_SENSOR_ABP = SYSCRG | 0x204,
        SYSCRG_CLK_TEMPERATURE_SENSOR     = SYSCRG | 0x208,
        ...
        SYSCRG_CLK_RSTN_U0_TEMP_SENSOR_RSTN_APB  = SYSCRG | (3 << 16) | 27,
        SYSCRG_CLK_RSTN_U0_TEMP_SENSOR_RSTN_TEMP = SYSCRG | (3 << 16) | 28,
