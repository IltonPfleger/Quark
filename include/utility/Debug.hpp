...
#define TraceIn(...)                                                                                                                                                               \
    if constexpr (QUARK::Traits<QUARK::Debug>::Trace) {                                                                                                                            \
        ...
        QUARK::Console::print('(');                                                                                                                                                \
        __VA_OPT__(int n = 0; [&](auto &&...args) { ((QUARK::Console::print(n++ ? ',' : '\0', args)), ...); }(__VA_ARGS__);)                                                       \
        Console::println(") {");                                                                                                                                                   \
    }

#define TraceOut(...)                                                                                                                                                              \
    if constexpr (QUARK::Traits<QUARK::Debug>::Trace) {                                                                                                                            \
        __VA_OPT__(QUARK::Console::print("return="); int n = 0; [&](auto &&...args) { ((QUARK::Console::print(n++ ? ',' : '\0', args)), ...); }(__VA_ARGS__);                      \
                   QUARK::Console::print('\n');)                                                                                                                                   \
