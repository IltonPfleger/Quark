...
typedef char  Int8;
typedef short Int16;
typedef IF<Traits<CPU>::WORD_SIZE == 32, int /* IPL32 */, int /* LP64 */>::Result Int32;
...
typedef IF<Traits<CPU>::WORD_SIZE == 32, unsigned int /* IPL32 */, unsigned int /* LP64 */>::Result UInt32;
...
template<> class Padding<16> { short _padding;     } __attribute__((packed));
template<> class Padding<32> { Int32 _padding;      } __attribute__((packed));
template<> class Padding<64> { Int64 _padding; } __attribute__((packed));

// __END_UTIL

// __BEGIN_SYS

static const Int32 MAX_INT = -1U/2;
//static const Int32  MAX_LONG_INT = -1UL/2;
static const Int64 MAX_LONG_LONG_INT = -1ULL/2;
static const unsigned MAX_UNSIGNED = -1U;
static const UInt32 MAX_UNSIGNED_INT = -1U;
static const UInt64 MAX_UNSIGNED_LONG_LONG = -1ULL;
...
// typedef IF<(Traits<System>::LIFE_SPAN * 1000000 <= MAX_UNSIGNED_LONG), UInt32,
//            IF<(Traits<System>::LIFE_SPAN * 1000000ULL <= MAX_UNSIGNED_LONG_LONG), UInt64 Time_Base;
typedef UInt64 Time_Base;
...
enum Infinity : Time_Base { INFINITE = MAX_LONG_LONG_INT/*-1ULL*/ };
enum Infinity32 : Time_Base { INFINITE32 = MAX_INT/*-1U*/ };
...
typedef UInt32 PPM; // parts per million
typedef UInt64 PPB; // parts per billion
