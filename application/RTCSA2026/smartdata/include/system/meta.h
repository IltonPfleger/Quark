...
// Native type wrpayloader (POD)
template <typename T1>
class Native_Wrpayloader
{
public:
	typedef T1 Type;
...
public:
    Native_Wrpayloader() {}
    Native_Wrpayloader(const Native_Wrpayloader & value): _value(value._value) {}
    Native_Wrpayloader(const T1 & value): _value(value) {}
    template<typename T2>
    Native_Wrpayloader(const T2 & value): _value(T1(value)) {}
    ...
    template<typename T2>
    Native_Wrpayloader operator+(T2 value) const { return _value + T1(value); }
    template<typename T2>
    Native_Wrpayloader operator-(T2 value) const { return _value - T1(value); }
    template<typename T2>
    Native_Wrpayloader operator*(T2 value) const { return _value * T1(value); }
    ...
    template<typename T2>
    Native_Wrpayloader operator+(T2 value) volatile { return _value + T1(value); }
    template<typename T2>
    Native_Wrpayloader operator-(T2 value) volatile { return _value - T1(value); }
    template<typename T2>
    Native_Wrpayloader operator*(T2 value) volatile { return _value * T1(value); }
    ...
    template<typename T2>
    Native_Wrpayloader & operator+=(T2 value) { _value += T1(value); return *this; }
    template<typename T2>
    Native_Wrpayloader & operator-=(T2 value) { _value -= T1(value); return *this; }
    template<typename T2>
    Native_Wrpayloader & operator*=(T2 value) { _value *= T1(value); return *this; }
    ...
    Native_Wrpayloader & operator[](int i) { return *(this + i); }

    template<typename T3>
    friend T3 & operator<<(T3 & os, const Native_Wrpayloader & value) { os << value._value; return os; }
...
template<> struct UNSIGNED<long long> { typedef long long Result; };
