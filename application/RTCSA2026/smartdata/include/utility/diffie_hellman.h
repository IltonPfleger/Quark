...
{
public:
    static const UInt32 SECRET_SIZE = Cipher::KEY_SIZE;
    static const UInt32 PUBLIC_KEY_SIZE = 2 * SECRET_SIZE;
...
void Diffie_Hellman<Cipher>::Elliptic_Curve_Point::operator*=(const Coordinate & b)
{
    ...
    static const UInt32 bits_in_digit = sizeof(typename Coordinate::Digit) * 8;

    typename Coordinate::Digit now;
    UInt32 b_len = sizeof(Coordinate) / sizeof(typename Coordinate::Digit);
    ...
    UInt32 current_bit = bits_in_digit;
