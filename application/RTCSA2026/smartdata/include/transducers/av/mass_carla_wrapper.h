...
class Mass_Reader: public Transducer<SmartData::Unit::Mass|SmartData::Unit::F32>, private UDP_Socket::Observer
{
    friend Responsive_SmartData<Mass_Reader>;
...
using Mass = Responsive_SmartData<Mass_Reader>;
